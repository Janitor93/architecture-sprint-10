...
1. **Заполнение данных**. Все данные вносятся и обрабатываются сотрудниками в ручном режиме в файлы. Высок риск сделать ошибку, сохранить что-то не туда.
...
6. **Резервирование**. Данные не резервируются, их можно потерять. Особенно учитывая тот факт, что доступ имеют все и обработка всех данных делается в ручную.
